...
- PHP resides inside container named php. In order to execute PHP commands, use: `docker-compose exec php php <command>` or `docker-compose exec php <other command>`. For example, to run migrations: `docker-compose exec php php artisan migrate`.
---