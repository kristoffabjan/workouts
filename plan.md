...
- [x] Ensure all sensitive data is managed via secrets in deployment pipeline
...
### Fixes
- [x] Seeders
  - [x] ExerciseSeeder:Integrity constraint violation: 1048 Column 'created_by' cannot be null
